...
def attack(char_name: str, char_class: str) -> str:
    """Атакует противника на соответствующее классу количество очков."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокирует урон на соответствующее классу количество очков."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет соответствующее классу особое умение."""
    if char_class == 'warrior':
